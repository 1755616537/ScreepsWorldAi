...
export const queueTask_W39N53 = {
    ...
    */
    run: function() {
        ...
        //#1-1 单兵建设1
        if(taskNewRoomBuild.run('1-1', 4, nameRoom, moduleNewRoomBuilder, 0, spawnName[nameRoom][0]) != 0)
            reportWrongExit.run('#1-1 单兵建设1');
            
        //#1-2 单兵建设2
        if(taskNewRoomBuild.run('1-2', 3, nameRoom, moduleNewRoomBuilder, 1, spawnName[nameRoom][0]) != 0)
