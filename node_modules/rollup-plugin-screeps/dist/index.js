...
function writeSourceMaps(options) {
    ...
    const mapFileWithExport = options.file + '.map.js';
    
    try {
        let contents = fs.readFileSync(mapFile, 'utf8');
        contents = `module.exports = ${contents};`;
        fs.writeFileSync(mapFileWithExport, contents, 'utf8');
        console.log('Added module.exports to main.js.map and renamed to main.js.map.js');
        fs.unlinkSync(mapFile); // Remove the original .map file
    } catch (error) {
        console.error('Error processing source map file:', error);
    }
}
