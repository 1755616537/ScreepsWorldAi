...
function mount(){
    ...
    registerAnalysis(WarTeamFlag,"WarTeamFlag");
    registerAnalysis(WarCache,"WarCache");
    registerAnalysis(WarTeamCore,"WarTeamCore");
    registerAnalysis(WarDamageCal,"WarDamageCal");
    ...
    registerAnalysis(StationObserver,"StationObserver");
    registerAnalysis(StationFactory,"StationFactory");
    ...
    registerAnalysis(StrategyMinSizeRoom,"StrategyMinSizeRoom");
    ...
    registerAnalysis(StrategyMarket,"StrategyMarket");
    registerAnalysis(StrategyClaimCrossShard,"StrategyClaimCrossShard");
    registerAnalysis(StrategyDeposits,"StrategyDeposits");
    registerAnalysis(StrategyPowerBank,"StrategyPowerBank");
    registerAnalysis(StrategyFactoryPowerCreep,"StrategyFactoryPowerCreep");
    registerAnalysis(StrategyMarketPrice,"StrategyMarketPrice");


    registerAnalysis(TeamRaL1,"TeamRaL1");
